                        ...
                        children: [
                                                          ...
                                                          return FlutterFlowAudioPlayer(
                                                            audio:
                                                              ...
                                                              metas: Metas(
                                                                ...
                                                                title:
                                                                    '${containerMusicRecord.title} - ${audioPlayerSupportGroupsRecord.groupname}',
                                                              ),
                                                            ),
                                                            titleTextStyle:
                                                                FlutterFlowTheme.of(
                                  ...
                                  child: StreamBuilder<List<MusicRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      if (listViewMusicRecordList.isEmpty) {
                                        return const EmptyStateSimpleWidget(
                                          body:
                                              'No musics have been posted yet.',
                                          title: 'No activity',
                                        );
                                      }
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewMusicRecordList.length,
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                FutureBuilder<List<PodcastRecord>>(
                                  future: queryPodcastRecordOnce(
                                    queryBuilder: (podcastRecord) =>
                                        podcastRecord.orderBy('Likes',
                                            descending: true),
                                    singleRecord: true,
                                  ),
                                  builder: (context, snapshot) {
                                                          ...
                                                          return FlutterFlowAudioPlayer(
                                                            audio:
                                                              ...
                                                              metas: Metas(
                                                                ...
                                                                title:
                                                                    '${containerPodcastRecord.title}  -  ${audioPlayerSupportGroupsRecord.groupname}',
                                                              ),
                                                            ),
                                                            titleTextStyle:
                                                                FlutterFlowTheme.of(
                                ...
                                Flexible(
                                  child: StreamBuilder<List<PodcastRecord>>(
                                    stream: queryPodcastRecord(
                                      queryBuilder: (podcastRecord) =>
                                          podcastRecord.orderBy('PostedTime'),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                      ...
                                      List<PodcastRecord>
                                          ...
                                          snapshot.data!;
                                      if (listViewPodcastRecordList.isEmpty) {
                                        return const EmptyStateSimpleWidget(
                                          body:
                                                ...
                                                return FlutterFlowAudioPlayer(
                                                  audio: Audio.network(
                                                    ...
                                                    metas: Metas(
                                                      ...
                                                      title:
                                                          '${listViewPodcastRecord.title} - ${audioPlayerSupportGroupsRecord.groupname}',
                                                    ),
                                                  ),
                                                  titleTextStyle:
                                                      FlutterFlowTheme.of(
