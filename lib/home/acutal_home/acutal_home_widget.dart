                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ACUTAL_HOME_Container_kyq4pbew_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');

                                context.pushNamed('dailyroutine');
                              },
                              child: Material(
                                              ...
                                              Flexible(
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ra6q9krw' /* Daily Progress Tracker */,
                                                  ),
