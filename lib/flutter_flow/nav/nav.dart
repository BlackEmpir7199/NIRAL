...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const AccountAuthCreateWidget(),
        ),
        FFRoute(
          name: 'CreateAccount4',
          path: '/createAccount4',
        ...
        FFRoute(
          name: 'Login4',
          path: '/login4',
          builder: (context, params) => const Login4Widget(),
        ),
        FFRoute(
          name: 'CommunityHome',
          path: '/communityHome',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CommunityHome')
              : const CommunityHomeWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CounsellingSchedulingWidget(),
        ),
        FFRoute(
          name: 'meditate',
          path: '/meditate',
          builder: (context, params) => const MeditateWidget(),
        ),
        FFRoute(
          name: 'therapist_home_page',
          path: '/therapistHomePage',
          builder: (context, params) => const TherapistHomePageWidget(),
        ),
        FFRoute(
          name: 'StreamList',
          path: '/streamList',
          builder: (context, params) => const StreamListWidget(),
        ),
        FFRoute(
          name: 'livestreamer',
          path: '/livestreamer',
        ...
        FFRoute(
          ...
          path: '/acutalHome',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'acutalHome')
              : const AcutalHomeWidget(),
        ),
        FFRoute(
          name: 'SkipSurvey',
          path: '/skipSurvey',
          builder: (context, params) => const SkipSurveyWidget(),
        ),
        FFRoute(
          name: 'supportHub',
          path: '/supportHub',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'supportHub')
              : const SupportHubWidget(),
        ),
        FFRoute(
          name: 'GroupProfile',
          path: '/groupProfile',
        ...
        FFRoute(
          ...
          path: '/artGallery',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'ArtGallery')
              : const ArtGalleryWidget(),
        ),
        FFRoute(
          name: 'PicturesPage',
          path: '/picturesPage',
          builder: (context, params) => const PicturesPageWidget(),
        ),
        FFRoute(
          name: 'SurvivorStory',
          path: '/survivorStory',
        ...
        FFRoute(
          name: 'NiralWay',
          path: '/niralWay',
          builder: (context, params) => const NiralWayWidget(),
        ),
        FFRoute(
          name: 'dailyroutine',
          path: '/dailyroutine',
        ...
        FFRoute(
          name: 'Documents',
          path: '/documents',
          builder: (context, params) => const DocumentsWidget(),
        ),
        FFRoute(
          name: 'Campaings',
          path: '/campaings',
          builder: (context, params) => const CampaingsWidget(),
        ),
        FFRoute(
          name: 'affirmations',
          path: '/affirmations',
          builder: (context, params) => const AffirmationsWidget(),
        ),
        FFRoute(
          name: 'Blogspage',
          path: '/blogspage',
        ...
        FFRoute(
          name: 'BambooChat',
          path: '/bambooChat',
          builder: (context, params) => const BambooChatWidget(),
        ),
        FFRoute(
          name: 'findsafeplace',
          path: '/findsafeplace',
          builder: (context, params) => const FindsafeplaceWidget(),
        ),
        FFRoute(
          name: 'PanicAttack',
          path: '/panicAttack',
          builder: (context, params) => const PanicAttackWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Another_subtle_logo_for_an_app_called_Niral,_which_is_a_revolutionary_rehab_platform_for_sexu_1.png',
                    fit: BoxFit.fitWidth,
                  ),
                )
              : page;
